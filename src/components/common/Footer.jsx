...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (email) {
      alert('You have been subscribed to our newsletter successfully!');
  ...
  return (
    <FooterWrapper>
      <TermsAndConditionsCard show={showTerms} onClose={handleCloseTerms} />
        ...
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            ...
            <p className='para-text'>
              Dive into the ultimate gaming adventure! Enjoy stunning graphics, thrilling gameplay, and endless fun. Join the excitement!"
            </p>
          </div>
          ...
          <div className='footer-item'>
            ...
            <ul className='footer-item-links'>
              <li><a href="#top-genres" className='text-white'>Gaming</a></li>
              <li><a href="#our-game-stores" className='text-white'>Product</a></li>
              <li><a href="#join-our-community" className='text-white'>Community</a></li>
            </ul>
          </div>
          ...
          <div className='footer-item'>
            ...
            <p className='para-text'>Subscribe to our newsletter to get our latest updates & news.</p>
      ...
      <div className='footer-bottom'>
        <div className='container d-flex flex-column text-center'>
          <p className='footer-bottom-text text-green'>NEBULA©COPYRIGHT</p>
          <ul className='footer-bottom-links d-flex justify-content-center'>
            ...
            <li><a href="#" className='text-white' onClick={handleTermsClick}>Terms & conditions</a></li>
          </ul>
        </div>
      </div>
    </FooterWrapper>
