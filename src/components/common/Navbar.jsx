          ...
          <div className={`navbar-collapse ${sidebarStatus ? 'show' : ''}`}>
            ...
            <ul className="connect-list d-flex justify-content-center align-items-center mt-5 flex-wrap">
              ...
              <li className="connect-item">
                <a href="https://www.twitch.tv/directory/gaming" className="connect-link" target="_blank" rel="noopener noreferrer">
                  <BsTwitch size={18} />
                </a>
              </li>
              <li className="connect-item">
                <a href="https://www.youtube.com/gaming" className="connect-link" target="_blank" rel="noopener noreferrer">
                  <BsYoutube size={19} />
                </a>
              </li>
            </ul>
